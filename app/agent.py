...
6. 進め方・仕様・対象が曖昧なときは、推測で進めず ask_user で選択肢(2〜4個)を提示して確認する。
...
_T_ASK = {"type": "function", "function": {
    "name": "ask_user",
    "description": "進め方や仕様が不明・曖昧なときに、推測せずユーザーへ質問する。選択肢を2〜4個提示して選んでもらう。",
    "parameters": {"type": "object", "properties": {
...
PLAN_PHASE_TOOLS = READ_TOOLS + [_T_TODO, _T_ASK, _T_PLAN]
